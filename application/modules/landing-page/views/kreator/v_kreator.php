<div class="container">
  <div id="soal" class="soal">
    <form method="POST" id="form-member">
      ...
      <div id="kds" class="collapse">
        <?php $this->load->view($kds); ?>
      </div>
      <div id="thanks" class="collapse">
        <div class="container text-center">
          ...
          <br>
          <div class="mt-2">
            <a href="whatsapp://send?text=surveidigital.lsf.go.id/form-data-diri.html" data-action="share/whatsapp/share" class="btn btn-outline-success rounded-circle" target="_blank"><i class="fa fa-whatsapp"></i></a>

            <a href="https://www.facebook.com/sharer/sharer.php?u=surveidigital.lsf.go.id/form-data-diri.html" class="btn btn-outline-primary rounded-circle" target="_blank"><i class="fa fa-facebook"></i></a>

            <a href="https://twitter.com/intent/tweet?text=surveidigital.lsf.go.id/form-data-diri.html" class="btn btn-outline-info rounded-circle" target="_blank"><i class="fa fa-twitter"></i></a>
          </div>
        </div>
      </div>
    </form>
